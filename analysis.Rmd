...
models <- tibble(name = c("full", "manip_check", "dummy"),
  ...
  mutate(data = map(1:n(), ~raw %>%
         ...
         txt_formula = case_when(
           ...
           name == "manip_check" ~ paste0(txt_formula, " + corResp:valid"),
           name == "dummy" ~ paste0("(", txt_formula, ")^2")),
